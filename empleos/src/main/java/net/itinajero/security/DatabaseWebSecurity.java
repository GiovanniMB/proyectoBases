...
public class DatabaseWebSecurity
{
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception
	{
		...
		.requestMatchers("/","/userExist", "/login", "/signup/**", "/search", "/bcrypt/**", "/about", "/vacantes/view/**","/Millan","/Tajonar","/historiaEmpresa","/juegoOc").permitAll()

		// Asignar permisos a URLs por ROLES
		.requestMatchers("/solicitudes/create/**","/solicitudes/save/**").hasAnyAuthority("USUARIO")
		.requestMatchers("/solicitudes/**").hasAnyAuthority("SUPERVISOR","ADMINISTRADOR","RH")
		.requestMatchers("/vacantes/**").hasAnyAuthority("SUPERVISOR","ADMINISTRADOR","RH")
		.requestMatchers("/categorias/**").hasAnyAuthority("SUPERVISOR","ADMINISTRADOR","RH") 
